#################################################################################################
## Process the elevation .tif from GEE to match the MODIS data and also to match the landsat data 
##################################################################################################
library(raster)
library(rgdal)
library(gdalUtils)
...
fout <- paste0(home,"/Topography/usgsNED_elevation/elevation500m.tif" )
