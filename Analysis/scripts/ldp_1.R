...
## Identify droughts and retrieve ET anomalies and SPI at drought peak 
########################################################################################
library(rgdal)
library(raster)
library(lubridate)
...
# for each year identify if there is a drought peak during the growing season 
# get the ET anomaly and SPI at drought peak and the index at drought peak and save as rasters
# do this for each year and tile combo 
ptm <- proc.time()
