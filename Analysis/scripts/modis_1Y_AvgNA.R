...
betas_file <- paste0(home, "/Analysis/outputs/MODIS_1Y/model_beta_coef.csv")
fmask <- paste0(home, "/Data/landcover/MODIS_FOREST/modis_permanent_forest_resampled.tif")

avgNA_tl(files_dt_gs$spi_file, files_dt_gs$et_file, betas_file, fmask, cl, "MODIS_1Y", tl = NA)
